...
def prep_train_models(model = "all", cat = "general"):
    ...
    suffix = ''
    if cat == "general": suffix = '_general'
    ...
    if cat == "general" or cat == "Naive Bayes":
        ...
        pkl_filename = "models/naive_bayes_model" + suffix + ".pkl"
    ...
    if cat == "general" or cat == "logisitic regression":
        ...
        pkl_filename = "models/logistic_regression_model" +  suffix  + ".pkl"
        with open(pkl_filename, 'wb') as file:
    ...
    if cat == "general" or cat == "svm":
        ...
        # Fitting the data into the model
        svm.fit(X_cv, y)
        pkl_filename = "models/svm_model" + suffix + ".pkl"
        with open(pkl_filename, 'wb') as file:
    ...
    if cat == "general" or cat == "decision tree":
        ...
        pkl_filename = "models/decision_tree_model" +  suffix + ".pkl"
        with open(pkl_filename, 'wb') as file:
    ...
    if cat == "general" or cat == "random forest":
        ...
        pkl_filename = "models/random_forest_model" + suffix + ".pkl"
        with open(pkl_filename, 'wb') as file:
